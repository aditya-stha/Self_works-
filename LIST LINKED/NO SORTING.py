        ...
        if freeslots==len(data):
            ...
            match listorder:
                case 0:#Sequential
                    ...
                    global head,freeIndex,order
                    if data[freeIndex] !=None:
                        ...
                        if current!=None:
                            match order:
                                case 0:
                                    logic = linkdata > data[current]
                                case 1:
                                    logic = linkdata > data[current]
                        else:
                            logic=False
                        while current!=None and logic:
                            PrevNodeIndex=current
                            current=ref[current]
                        if current == head:
                            head=newIndex
                        else:
                            ref[PrevNodeIndex]=newIndex
                        ref[newIndex]=current
...
def initialize():
    global data,ref,listorder,order,freeslots,datatype,dtype,head,freeIndex
